...
public enum Submode implements AdifEnumCode {
    _8PSK125("8PSK125", Mode.PSK),
    _8PSK125F("8PSK125F", Mode.PSK),
    _8PSK125FL("8PSK125F", Mode.PSK),
    _8PSK250("8PSK250", Mode.PSK),
    _8PSK250F("8PSK250F", Mode.PSK),
    _8PSK250FL("8PSK250FL", Mode.PSK),
    _8PSK500("8PSK500", Mode.PSK),
    _8PSK500F("8PSK500F", Mode.PSK),
    _8PSK1000("8PSK1000", Mode.PSK),
    _8PSK1000F("8PSK1000F", Mode.PSK),
    ...
    SCAMP_FAST("SCAMP_FAST", Mode.FSK),
    SCAMP_OO("SCAMP_OO", Mode.MTONE),
    SCAMP_OO_SLOW("SCAMP_OO_SLOW", Mode.MTONE),
    SCAMP_SLOW("SCAMP_SLOW", Mode.FSK),
    SCAMP_VSLOW("SCAMP_VSLOW", Mode.FSK),
